<x-app-layout>
    ...
    <script>
        // Calendar with month navigation for edit
        ...
        function renderCalendar() {
            ...
            for (let i = 0; i < 42; i++) {
                ...
                const isBooked = bookedDates.includes(dateString) && dateString !== selectedDate;
                ...
                if (!isCurrentMonth) {
                    ...
                    dayBtn.disabled = true;
                    dayBtn.title = 'Booked';
                } else if (date < today && dateString !== selectedDate) {
